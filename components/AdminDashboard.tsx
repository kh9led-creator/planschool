...
const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  return (
    <div className="w-full bg-slate-50 min-h-screen">
      ...
      {/* FREEZE BANNER */}
      {isFrozen && (
          <div className="bg-red-600 text-white p-4 text-center sticky top-0 z-[60] shadow-lg animate-slideDown no-print">
                 ...
                 {viewingArchive && (
                     <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex flex-col items-center justify-center p-4 overflow-hidden">
                         <div className="bg-white w-full max-w-4xl h-[90vh] rounded-2xl flex flex-col shadow-2xl animate-slideDown overflow-hidden">
                             <div className="bg-slate-800 text-white p-4 flex justify-between items-center shrink-0 no-print">
                 ...
                 {viewingAttendanceArchive && (
                     <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex flex-col items-center justify-center p-4 overflow-hidden">
                         <div className="bg-white w-full max-w-4xl h-[90vh] rounded-2xl flex flex-col shadow-2xl animate-slideDown overflow-hidden">
                             ...
                             <div className="flex-1 overflow-auto bg-slate-100 p-8 flex justify-center"><div className="scale-90 origin-top page-container"><AttendanceReportTemplate schoolSettings={schoolSettings} classGroup={{id: 'archived', name: 'تقرير مؤرشف'}} teacherName="أرشيف النظام" date={viewingAttendanceArchive.reportDate} absentStudents={viewingAttendanceArchive.absentStudents} showClassColumn={true}/></div></div>
                         </div>
                     </div>
                 )}
             </div>
